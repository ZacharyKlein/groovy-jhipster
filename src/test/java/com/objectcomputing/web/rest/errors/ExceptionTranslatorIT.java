package com.objectcomputing.web.rest.errors;

import com.objectcomputing.GroovyjhipsterApp;
import com.objectcomputing.web.rest.errors.handlers.ProblemHandler;
 ...
 */
@MicronautTest(application = GroovyjhipsterApp.class)
