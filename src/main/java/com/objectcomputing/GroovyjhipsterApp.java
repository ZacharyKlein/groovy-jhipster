...
import com.objectcomputing.config.DefaultProfileUtil;
...
public class GroovyjhipsterApp {

    private static final Logger log = LoggerFactory.getLogger(GroovyjhipsterApp.class);

    /**
     * Initializes GroovyjhipsterApp.
     * <p>
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext context = Micronaut.build(args)
            .mainClass(GroovyjhipsterApp.class)
