...
## Micronaut JHipster + Groovy - Demo

The _master_ branch contains a "stock" JHipster Micronaut app. The _groovy_ branch includes additional dependencies, config and sample code showing how to make use of Groovy in a Micronaut/Java application, including making use of Groovy for controllers, tests, injected beans, and application configuration.

> ## 🛠 Blueprint In Active Development
>
> This project was generated by a _PREVIEW_ of a [Micronaut](https://micronaut.io) blueprint for [JHipster](https://jhipster.tech).
